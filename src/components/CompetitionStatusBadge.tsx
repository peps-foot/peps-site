...
export default function CompetitionStatusBadge({ competitionId, mode }: Props) {
  ...
  useEffect(() => {
    ...
    // taille fixe + anti-wrap + ne pas rétrécir dans le flex parent
    const box =
        "w-32 h-9 inline-flex items-center justify-center rounded border font-medium " +
        "text-center whitespace-nowrap tabular-nums flex-none";
